It's time to have some fun with chocolat!
...
Tempering chocolate is pretty hard to do, especially when creating a large batch. The best way to learn, is to look at the exerts. So look at the video from the factory [here](https://www.youtube.com/watch?v=6ols7xO_xbU). As you can see, they use a mold and fill it up with choclate. Then they throw out the chocolate and it sticks to the plastic mold. Apparently they use the temperature to control the flow of the chocolate.
...
It's an exact science, but don't be afraid if you don't get it precise. It's fun to do and you don't need to be a professional to create something.
...
Once you got your bowl with milk chocolate ready, you need to fill the mold. Fill it up and then right after poor it out. Make sure to shake it. However, make sure to check how thick the walls are at that point, because the more you shake, the thinner the walls will get. You can get it very thin!
...
Because I used a hard plastic mold (mostly you see silicon molds), you need another process to remove it from the mold. The trick is to put it in your freezer for a while (around 30 minutes). You'll notice the air flowing on the outside in between the mold and the chocolate. When that occurs it's ready to be removed. Be sure to remove any overflowing chocolate that has hardened (with a knive). If you don't, you might end up with broken edges. 
